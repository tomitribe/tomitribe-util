...
public final class Slice
    ...
    /**
     * Returns the byte array wrapped by this Slice, if any. Callers are expected to check
     * {@link Slice#hasByteArray()} before calling
     * this method since not all instances are backed by a byte array. Callers should also take care to use
     * {@link Slice#byteArrayOffset()}
     ...
     *                                   or if the specified {@code index + length} is greater than {@code this
     *                                   .length()}
     */
